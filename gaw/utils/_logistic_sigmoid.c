...
#define __PYX_HAVE__gaw__utils___logistic_sigmoid
#define __PYX_HAVE_API__gaw__utils___logistic_sigmoid
#include "math.h"
#include "string.h"
#include "stdio.h"
#include "stdlib.h"
...
static const char *__pyx_f[] = {
  "gaw/utils/_logistic_sigmoid.pyx",
  "__init__.pxd",
  "type.pxd",
};
...
/* "gaw/utils/_logistic_sigmoid.pyx":10
 * cimport numpy as np
 * 
 ...
 * 
 */
typedef __pyx_t_5numpy_float64_t __pyx_t_3gaw_5utils_17_logistic_sigmoid_DTYPE_t;
/* None.proto */
#if CYTHON_CCOMPLEX
  #ifdef __cplusplus
...
/* Module declarations from 'gaw.utils._logistic_sigmoid' */
static __pyx_t_3gaw_5utils_17_logistic_sigmoid_DTYPE_t __pyx_f_3gaw_5utils_17_logistic_sigmoid__inner_log_logistic_sigmoid(__pyx_t_3gaw_5utils_17_logistic_sigmoid_DTYPE_t); /*proto*/
static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_3gaw_5utils_17_logistic_sigmoid_DTYPE_t = { "DTYPE_t", NULL, sizeof(__pyx_t_3gaw_5utils_17_logistic_sigmoid_DTYPE_t), { 0 }, 0, 'R', 0, 0 };
#define __Pyx_MODULE_NAME "gaw.utils._logistic_sigmoid"
int __pyx_module_is_main_gaw__utils___logistic_sigmoid = 0;

/* Implementation of 'gaw.utils._logistic_sigmoid' */
...
static const char __pyx_k_gaw_utils__logistic_sigmoid[] = "gaw.utils._logistic_sigmoid";
static const char __pyx_k_ndarray_is_not_C_contiguous[] = "ndarray is not C contiguous";
static const char __pyx_k_Users_nkdhny_Documents_datasoup[] = "/Users/nkdhny/Documents/datasoup/gawdistance/gaw/utils/_logistic_sigmoid.pyx";
...
static PyObject *__pyx_n_s_gaw_utils__logistic_sigmoid;
...
static PyObject *__pyx_pf_3gaw_5utils_17_logistic_sigmoid__log_logistic_sigmoid(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_n_samples, int __pyx_v_n_features, PyArrayObject *__pyx_v_X, PyArrayObject *__pyx_v_out); /* proto */
...
/* "gaw/utils/_logistic_sigmoid.pyx":13
 * 
 * 
...
static __pyx_t_3gaw_5utils_17_logistic_sigmoid_DTYPE_t __pyx_f_3gaw_5utils_17_logistic_sigmoid__inner_log_logistic_sigmoid(__pyx_t_3gaw_5utils_17_logistic_sigmoid_DTYPE_t __pyx_v_x) {
  __pyx_t_3gaw_5utils_17_logistic_sigmoid_DTYPE_t __pyx_r;
  __Pyx_RefNannyDeclarations
  int __pyx_t_1;
  __Pyx_RefNannySetupContext("_inner_log_logistic_sigmoid", 0);

  /* "gaw/utils/_logistic_sigmoid.pyx":15
 * cdef DTYPE_t _inner_log_logistic_sigmoid(DTYPE_t x):
 *     """Log of the logistic sigmoid function log(1 / (1 + e ** -x))"""
 *     if x > 0:             # <<<<<<<<<<<<<<
 *         return -log(1 + exp(-x))
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "gaw/utils/_logistic_sigmoid.pyx":16
 *     """Log of the logistic sigmoid function log(1 / (1 + e ** -x))"""
 *     if x > 0:
 *         return -log(1 + exp(-x))             # <<<<<<<<<<<<<<
 *     else:
 ...
 */
  ...
  /* "gaw/utils/_logistic_sigmoid.pyx":18
 *         return -log(1 + exp(-x))
 *     else:
 *         return x - log(1 + exp(x))             # <<<<<<<<<<<<<<
 * 
...
/* "gaw/utils/_logistic_sigmoid.pyx":21
 * 
 * 
...
/* Python wrapper */
static PyObject *__pyx_pw_3gaw_5utils_17_logistic_sigmoid_1_log_logistic_sigmoid(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_3gaw_5utils_17_logistic_sigmoid_1_log_logistic_sigmoid = {"_log_logistic_sigmoid", (PyCFunction)__pyx_pw_3gaw_5utils_17_logistic_sigmoid_1_log_logistic_sigmoid, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_3gaw_5utils_17_logistic_sigmoid_1_log_logistic_sigmoid(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_L3_error:;
  __Pyx_AddTraceback("gaw.utils._logistic_sigmoid._log_logistic_sigmoid", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  ...
  __pyx_r = __pyx_pf_3gaw_5utils_17_logistic_sigmoid__log_logistic_sigmoid(__pyx_self, __pyx_v_n_samples, __pyx_v_n_features, __pyx_v_X, __pyx_v_out);
...
static PyObject *__pyx_pf_3gaw_5utils_17_logistic_sigmoid__log_logistic_sigmoid(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_n_samples, int __pyx_v_n_features, PyArrayObject *__pyx_v_X, PyArrayObject *__pyx_v_out) {
  int __pyx_v_i;
  int __pyx_v_j;
  ...
  __pyx_pybuffernd_out.rcbuffer = &__pyx_pybuffer_out;
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_X.rcbuffer->pybuffer, (PyObject*)__pyx_v_X, &__Pyx_TypeInfo_nn___pyx_t_3gaw_5utils_17_logistic_sigmoid_DTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) __PYX_ERR(0, 21, __pyx_L1_error)
  }
  __pyx_pybuffernd_X.diminfo[0].strides = __pyx_pybuffernd_X.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_X.diminfo[0].shape = __pyx_pybuffernd_X.rcbuffer->pybuffer.shape[0]; __pyx_pybuffernd_X.diminfo[1].strides = __pyx_pybuffernd_X.rcbuffer->pybuffer.strides[1]; __pyx_pybuffernd_X.diminfo[1].shape = __pyx_pybuffernd_X.rcbuffer->pybuffer.shape[1];
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_out.rcbuffer->pybuffer, (PyObject*)__pyx_v_out, &__Pyx_TypeInfo_nn___pyx_t_3gaw_5utils_17_logistic_sigmoid_DTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 2, 0, __pyx_stack) == -1)) __PYX_ERR(0, 21, __pyx_L1_error)
  }
  ...
  /* "gaw/utils/_logistic_sigmoid.pyx":24
 *                            np.ndarray[DTYPE_t, ndim=2] X,
 *                            np.ndarray[DTYPE_t, ndim=2] out):
 ...
 */
  ...
  for (__pyx_t_2 = 0; __pyx_t_2 < __pyx_t_1; __pyx_t_2+=1) {
    ...
    /* "gaw/utils/_logistic_sigmoid.pyx":25
 *                            np.ndarray[DTYPE_t, ndim=2] out):
 *     for i in range(n_samples):
 *         for j in range(n_features):             # <<<<<<<<<<<<<<
 *             out[i, j] = _inner_log_logistic_sigmoid(X[i, j])
 ...
 */
    ...
    for (__pyx_t_4 = 0; __pyx_t_4 < __pyx_t_3; __pyx_t_4+=1) {
      ...
      /* "gaw/utils/_logistic_sigmoid.pyx":26
 *     for i in range(n_samples):
 *         for j in range(n_features):
 *             out[i, j] = _inner_log_logistic_sigmoid(X[i, j])             # <<<<<<<<<<<<<<
 *     return out
 */
      ...
      __pyx_t_7 = __pyx_v_i;
      __pyx_t_8 = __pyx_v_j;
      *__Pyx_BufPtrStrided2d(__pyx_t_3gaw_5utils_17_logistic_sigmoid_DTYPE_t *, __pyx_pybuffernd_out.rcbuffer->pybuffer.buf, __pyx_t_7, __pyx_pybuffernd_out.diminfo[0].strides, __pyx_t_8, __pyx_pybuffernd_out.diminfo[1].strides) = __pyx_f_3gaw_5utils_17_logistic_sigmoid__inner_log_logistic_sigmoid((*__Pyx_BufPtrStrided2d(__pyx_t_3gaw_5utils_17_logistic_sigmoid_DTYPE_t *, __pyx_pybuffernd_X.rcbuffer->pybuffer.buf, __pyx_t_5, __pyx_pybuffernd_X.diminfo[0].strides, __pyx_t_6, __pyx_pybuffernd_X.diminfo[1].strides)));
    }
  }

  /* "gaw/utils/_logistic_sigmoid.pyx":27
 *         for j in range(n_features):
 *             out[i, j] = _inner_log_logistic_sigmoid(X[i, j])
 *     return out             # <<<<<<<<<<<<<<
 */
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_gaw_utils__logistic_sigmoid, __pyx_k_gaw_utils__logistic_sigmoid, sizeof(__pyx_k_gaw_utils__logistic_sigmoid), 0, 0, 1, 1},
...
#endif
{
  ...
  #endif
  if (__pyx_module_is_main_gaw__utils___logistic_sigmoid) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "gaw.utils._logistic_sigmoid")) {
      if (unlikely(PyDict_SetItemString(modules, "gaw.utils._logistic_sigmoid", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "gaw/utils/_logistic_sigmoid.pyx":7
 ...
 *                            np.ndarray[DTYPE_t, ndim=2] out):
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_3gaw_5utils_17_logistic_sigmoid_1_log_logistic_sigmoid, NULL, __pyx_n_s_gaw_utils__logistic_sigmoid); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 21, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_log_logistic_sigmoid, __pyx_t_1) < 0) __PYX_ERR(0, 21, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "gaw/utils/_logistic_sigmoid.pyx":1
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init gaw.utils._logistic_sigmoid", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init gaw.utils._logistic_sigmoid");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
